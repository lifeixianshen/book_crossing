...
class LeftTabWidget(QWidget):
    ...
    def _setup_ui(self,LWindow):
        ...
        #self.label_0.setTextFormat(Qt.AutoText)
        #self.label_0.setStyleSheet("border:none;") # no border   
        #self.grid1.addWidget(self.label_0, 1, 0, 1, 2)
        # close button
        ...
        #self.grid1.addWidget(self.buttonClose, 1,6)
        # user Icon
        self.label_o = QLabel()
